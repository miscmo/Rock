...
int32_t FunctionServlet::handle(rock::http::HttpRequest::ptr request
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("rock/1.0"));
}

int32_t ServletDispatch::handle(rock::http::HttpRequest::ptr request
               , rock::http::HttpResponse::ptr response
               , rock::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(rock::http::HttpRequest::ptr request
                   , rock::http::HttpResponse::ptr response
                   , rock::http::HttpSession::ptr session) {
    response->setStatus(rock::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "rock/1.0.0");
