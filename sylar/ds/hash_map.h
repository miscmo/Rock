#ifndef __ROCK_DS_HASH_MAP2_H__
#define __ROCK_DS_HASH_MAP2_H__
...
public:
    ...
    void swap(HashMap& oth) {
        rock::RWMutex::WriteLock lock(m_mutex);
        rock::RWMutex::WriteLock lock2(oth.m_mutex);
...
template<class K
        ...
        ,class PosHash
        >
rock::RWMutex HashMap<K, V, PosHash>::s_mutex[MAX_MUTEX];
